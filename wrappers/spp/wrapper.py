...
tec.filter = {snakemake.params.tecfilter}; 
bp <- find.binding.positions(signal.data=chip.data.qua, control.data=input.data.qua, fdr=fdr, method=tag.lwcc,whs=detection.window.halfsize, tec.filter = {snakemake.params.tecfilter})
